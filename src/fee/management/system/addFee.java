...
public class addFee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(panelsidebar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 280, 670));
        ...
        txt_coursemode.setFont(new java.awt.Font("Times New Roman", 0, 15)); // NOI18N
        txt_coursemode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_coursemodeActionPerformed(evt);
            }
        });
        panel_child.add(txt_coursemode, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 75, 300, 28));
        ...
        panelParent.add(panel_child, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 182, 850, 490));
        panelParent.add(date_tran, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 70, 120, 30));

        getContentPane().add(panelParent, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 850, 670));

        setSize(new java.awt.Dimension(1145, 674));
